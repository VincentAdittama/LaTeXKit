...
1.  **DETECT PROJECT State**
    - Execute `PROJECT_ROOT=$(git rev-parse --show-toplevel) && source "$PROJECT_ROOT/.latexkit/scripts/bash/common.sh" && eval $(get_document_paths) && echo "ACTIVE_PROJECT=$ACTIVE_PROJECT"`
